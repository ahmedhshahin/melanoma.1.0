...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, data_path = "/content/unet-keras/my data/train/image", label_path = "/content/unet-keras/my data/train/label", test_path = "/content/unet-keras/my data/test", npy_path = "/content/unet-keras/npydata", img_type = "jpg"):
