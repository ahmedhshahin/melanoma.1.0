...
class myUnet(object):
	...
	def get_unet(self):
		...
		D2 = RepeatVector(65536)(D2)
		F = Reshape((256,256,512))(D2)
		print("==========================")
		...
		conv9 = BatchNormalization()(conv9)
		conv9 = Activation('relu')(conv9)
		merge10 = Concatenate()([conv9, F])
		conv10 = Conv2D(1, 1, activation = 'sigmoid')(merge10)
		print("conv10 shape:",merge10.shape)
	...
	def train(self):
		...
		history = model.fit([imgs_fft, imgs_train], imgs_mask_train, batch_size=8, epochs=250, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
