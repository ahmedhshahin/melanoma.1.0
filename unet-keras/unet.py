...
from keras.layers import Input, merge, Add, Average, Conv2D, MaxPooling2D, UpSampling2D, Dropout, Cropping2D, BatchNormalization, Activation
...
class myUnet(object):
	...
	def train(self):
		...
		model.fit(imgs_train, imgs_mask_train, batch_size=8	, epochs=120, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
