...
class myUnet(object):
	...
	def train(self):
		...
		model.fit(imgs_train, imgs_mask_train, batch_size=16, epochs=200, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
...
if __name__ == '__main__':
	myunet = myUnet(learning_rate=8e-4)
	myunet.train()
	myunet.save_img()
