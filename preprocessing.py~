...
img = "ISIC_0000006.jpg"
x_img = misc.imread(path + "/" + img)
[a,b] = x_img[:,:,0].shape


diag = gaussian_filter1d(np.average(np.diagonal(x_img[5:a-5, 5:b-5]),0).astype(int),7)
...
plt.plot(diag)
plt.show()
misc.imshow(x_img[seed-200:seed+200,seed-200:seed+200,:])
